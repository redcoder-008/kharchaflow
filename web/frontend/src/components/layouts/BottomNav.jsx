      ...
      >
        {menuItems.map((item) => {
          if (item.id === "placeholder") {
            return (
              <div key="placeholder-fab" className="flex items-center justify-center -mt-14 sm:-mt-16">
                <button
                  onClick={onQuickAddClick}
                  className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-emerald-500 hover:bg-emerald-400 text-zinc-950 flex items-center justify-center shadow-[0_6px_28px_rgba(16,185,129,0.5)] active:scale-90 transition-all duration-150 border-4 border-zinc-900 relative z-50"
